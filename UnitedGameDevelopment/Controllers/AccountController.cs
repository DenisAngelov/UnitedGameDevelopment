namespace UnitedGameDevelopment.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAccountService service)
            : this(service)
        {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (model.IsCompany)
                    {
                        ...
                        this.service.CreateCompany(user, model.Username);
                    }
                    else
                    {
                        this.UserManager.AddToRole(user.Id, "Freelancer");
                        this.service.CreateFreelancer(user, model.Username);
                    }
